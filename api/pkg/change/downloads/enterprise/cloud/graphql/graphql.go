...
func (r *ContentsDownloadURLRootResolver) InternalContentsDownloadTarGzUrl(ctx context.Context, change *change.Change) (resolvers.ContentsDownloadUrlResolver, error) {
	return r.download(ctx, change, service_downloads.ArchiveFormatTarGz)
}

func (r *ContentsDownloadURLRootResolver) InternalContentsDownloadZipUrl(ctx context.Context, change *change.Change) (resolvers.ContentsDownloadUrlResolver, error) {
	return r.download(ctx, change, service_downloads.ArchiveFormatZip)
}

func (r *ContentsDownloadURLRootResolver) download(ctx context.Context, change *change.Change, format service_downloads.ArchiveFormat) (resolvers.ContentsDownloadUrlResolver, error) {
