...
import (
	...
	view_auth "getsturdy.com/api/pkg/views/auth"
	db_view "getsturdy.com/api/pkg/views/db"
	meta_view "getsturdy.com/api/pkg/views/meta"
...
func ProvideHandler(
	...
	waitingListRepo waitinglist.WaitingListRepository,
	aclInterestRepo acl.ACLInterestRepository,
	instantIntegrationInterestRepo instantintegration.InstantIntegrationInterestRepository,
