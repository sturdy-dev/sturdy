...
func newTest(t *testing.T, operations []*operation) *test {
	...
	gitSnapshotter := snapshotter.NewGitSnapshotter(snapshotsDB, workspaceDB, workspaceDB, viewDB, suggestionRepo, eventsSender, nil, executorProvider, zap.NewNop())
	workspaceService := service_workspace.New(zap.NewNop(), analyticsService, workspaceDB, workspaceDB, nil, nil, nil, changeService, activityService, nil, nil, executorProvider, nil, nil, nil, gitSnapshotter, nil)
