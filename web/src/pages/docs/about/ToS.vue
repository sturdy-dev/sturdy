<template>
  <StaticPage title="Terms of Service" category="About" :wide="true">
    ...
    >
      <p>
        <span>Last updated:&nbsp;10/11/2021</span>
      </p>
      <ol class="text-black font-bold" start="1">
        <li>
          <span>Introduction</span>
        </li>
      </ol>
      <p>
        Welcome to Sturdy (“Company”, “we”, “our”, “us”)! As you have just clicked our Terms of
        Service, please pause, grab a cup of coffee and carefully read the following pages. It will
        take you approximately 20 minutes.
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of our web pages
        located at https://getsturdy.com operated by Sturdy.
      </p>
      <p>
        ...
        it here https://getsturdy.com/privacy.
      </p>
      <p>
      ...
      <p>
        ...
        <a href="mailto:support@getsturdy.com">support@getsturdy.com</a> so we can try to find a
        solution. These Terms apply to all visitors, users and others who wish to access or use
        Service.
      </p>
      <p>Thank you for being responsible.</p>
      <ol class="text-black font-bold" start="2">
        <li>
      ...
      <ol class="text-black font-bold" start="3">
        <li>
          <span>Purchases</span>
        </li>
      </ol>
      ...
      <ol class="text-black font-bold" start="4">
        <li>
      ...
      <p>
        ...
        same conditions unless you cancel it or Sturdy cancels it. You may cancel your Subscription
        renewal either through your online account management page or by contacting Sturdy customer
        support team.
      </p>
      <p>
        A valid payment method, including credit card, is required to process the payment for your
        subscription. You shall provide Sturdy with accurate and complete billing information
        including full name, address, state, zip code, telephone number, and a valid payment method
        information. By submitting such payment information, you automatically authorize Sturdy to
        charge all Subscription fees incurred through your account to any such payment instruments.
      </p>
      <p>
        Should automatic billing fail to occur for any reason, Sturdy will issue an electronic
      ...
      <ol class="text-black font-bold" start="5">
        <li>
          <span class="c0 c5">Free Trial</span>
        </li>
      </ol>
      <p>
        Sturdy may, at its sole discretion, offer a Subscription with a free trial for a limited
      ...
      <p>
        ...
        charged by Sturdy until Free Trial has expired. On the last day of Free Trial period, unless
      ...
      <p>
        At any time and without notice, Sturdy reserves the right to (i) modify Terms of Service of
        Free Trial offer, or (ii) cancel such Free Trial offer.
      </p>
      <ol class="text-black font-bold" start="6">
        <li>
          <span>Fee Changes</span>
        </li>
      </ol>
      <p>
        Sturdy, in its sole discretion and at any time, may modify Subscription fees for the
        Subscriptions. Any Subscription fee change will become effective at the end of the
        then-current Billing Cycle.
      </p>
      <p>
        Sturdy will provide you with a reasonable prior notice of any change in Subscription fees to
      ...
      <ol class="text-black font-bold" start="7">
        <li>
          <span>Refunds</span>
        </li>
      </ol>
      <p>Except when required by law, paid Subscription fees are non-refundable.</p>
      <ol class="text-black font-bold" start="8">
        <li>
          <span>Content</span>
        </li>
      </ol>
      <p>
        ...
        appropriateness. We are not responsible for any public display or misuse of your
        User-Generated Content.
      </p>

      <h4>Private codebases</h4>
      <p>
        By default codebases in Sturdy are private, allowing the User to control access to their
        Content.
      </p>
      <p>
        Sturdy treats the contents of your private codebases as confidential to you. This meant that
        the contents of private codebases on Sturdy will be protected from unauthorized access or
        use.
      </p>

      <p>
        Employees of Sturdy may only access your private codebases in the following specific cases:
      </p>

      <ul>
        <li>security purposes</li>
        <li>to assist the owner of a codebase with a support issue</li>
        <li>to maintain the integrity of the Service</li>
        <li>in order to comply with legal obligations</li>
        <li>if there is a reason to believe the contents illegal</li>
        <li>with your consent</li>
      </ul>

      <h4>Public codebases</h4>

      <p>
        While by default Codebases in Sturdy are private, optionally, the User can elect to make a
        codebase public.
      </p>
      ...
      <ol class="text-black font-bold" start="9">
        <li>
      ...
      <ol>
        ...
        <li>
          Use any robot, spider, or other automatic device, process, or means to access Service for
      ...
      <ol class="text-black font-bold" start="11">
        <li>
          <span>Accounts</span>
        </li>
      </ol>
      ...
      <ol class="text-black font-bold" start="12">
        <li>
      ...
      <p>
        ...
        functionality are and will remain the exclusive property of Sturdy and its licensors.
        Service is protected by copyright, trademark, and other laws of the United States and
        foreign countries. Our trademarks and trade dress may not be used in connection with any
        product or service without the prior written consent of Sturdy.
      </p>
      <ol class="text-black font-bold" start="13">
        <li>
      ...
      <p>
        ...
        <a href="mailto:support@getsturdy.com">support@getsturdy.com</a> with information and
        ...
        shall not retain, acquire or assert any intellectual property right or other right, title or
        ...
        confidentiality with respect to the Feedback. In the event the transfer of the ownership to
      ...
      <ol class="text-black font-bold" start="14">
        <li>
      ...
      <p>
        ...
        controlled by Sturdy.
      </p>
      <p>
        Sturdy has no control over, and assumes no responsibility for the content, privacy policies,
      ...
      <p>
        YOU ACKNOWLEDGE AND AGREE THAT STURDY SHALL NOT BE RESPONSIBLE OR LIABLE, DIRECTLY OR
      ...
      <ol class="text-black font-bold" start="15">
        <li id="h.30j0zll">
      ...
      <ol class="text-black font-bold" start="16">
        <li id="h.1fob9te">
      ...
      <ol class="text-black font-bold" start="17">
        <li>
      ...
      <ol class="text-black font-bold" start="18">
        <li>
      ...
      <p id="h.3znysh7">
        ...
        of&nbsp;Sweden&nbsp;without regard to its conflict of law provisions.
      </p>
      <p>
      ...
      <ol class="text-black font-bold" start="19">
        <li>
      ...
      <ol class="text-black font-bold" start="20">
        <li>
      ...
      <p>
        We may amend Terms at any time by posting the amended terms on this site. You will be
        notified of material changes to the Terms of Service at least 30 days prior to the
        amendments taking effect. The notice will be posted either by sending an email to the email
        address provided in your Sturdy account or by posting a prominent notice on the Website. By
        continuing to access or use our Service after any revisions become effective, you agree to
        be bound by the revised terms. For any minor modifications, by continuing to access Sturdy,
        you agree to be bound by the revised terms.
      </p>

      <ol class="text-black font-bold" start="21">
        <li id="h.2et92p0">
      ...
      <ol class="text-black font-bold" start="22">
        <li id="h.tyjcwt">
      ...
      <ol class="text-black font-bold" start="23">
        <li>
      ...
      <p>
        <span>By email: <a href="mailto:support@getsturdy.com">support@getsturdy.com</a>.</span>
      </p>
    </div>
  </StaticPage>
</template>
