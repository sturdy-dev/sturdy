    ...
    <template #default>
      <div class="prose p-4 max-w-[800px]">
        ...
        <p>
          ...
          no different from what you are used to.
        </p>
        ...
        <ol>
          ...
          <li>
            You can use the folder for accessing and editing code with any IDE or text editor you
            are used to (Tip: Use the Open in VSCode button for quick access)
          </li>
        ...
        <DocsInfoBox
          >Any time you create code changes, they "happen" in a Sturdy workspace. Workspaces provide
          isolation, just like Git branches – it’s where you work. The main difference between
          Sturdy and others is the highly automated workflow that it enables.</DocsInfoBox
        >
        ...
        <p>
          ...
          >
          – all of this is just a click away. You can read more about how Sturdy augments Git on
        ...
        <p>
          ...
          With that enabled, you will always get the latest changes by others.
        </p>
      </div>
    </template>
  </PublicLeftSidebar>
