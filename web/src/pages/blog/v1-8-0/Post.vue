<template>
  ...
  >
    ...
    <template #default>
      ...
      <p>
        Undoing restores the code changes in the draft to the state as it was of a previous
        snapshot. And takes just a few milliseconds to run. Clicking undo again, will restore you to
        an even earlier state. Redoing moves you forward to the state that you recently undid from.
        I guess that's a long way to describe that we've introduced Ctrl+Z and Ctrl+Y support to
        Sturdy!
      </p>
